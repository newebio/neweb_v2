...
class FileConfiguration {
    ...
    resolveTemplate() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!(yield util_1.promisify(fs_1.exists)(path_1.resolve(this.config.appDir + "/template.html")))) {
            ...
            return (yield util_1.promisify(fs_1.readFile)(path_1.resolve(this.config.appDir + "/template.html"))).toString();
        });
    }
    hasFrame(name) {
        return __awaiter(this, void 0, void 0, function* () {

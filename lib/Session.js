...
const diffModules_1 = require("../utils/diffModules");
class Session {
    constructor(config) {
        this.config = config;
    }
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.config.sid) {
                ...
                if (yield util_1.promisify(fs_1.exists)(this.config.sessionsPath + "/" + id + "/session.json")) {
                    const sessionInfo = JSON.parse((yield util_1.promisify(fs_1.readFile)(this.config.sessionsPath + "/" + id + "/session.json")).toString());
    ...
    render() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                ...
                data,
                modules: this.info ? diffModules_1.default(modules, this.info.modules) : modules,
            };
        });
    }
}

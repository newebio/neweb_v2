...
class ModulePacker {
    constructor(config) {
        ...
        this.nodeModulesPath = path_1.resolve(this.config.modulesPath + "/node");
    }
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            yield util_1.promisify(mkdirp)(this.localModulesPath);
            yield util_1.promisify(mkdirp)(this.nodeModulesPath);
                    ...
                    externals: [(context, childModuleName, callback) => __awaiter(this, void 0, void 0, function* () {
                            if (!childModuleName.startsWith(".") && childModuleName !== localPath) {
                                if (this.excludedModules.indexOf(childModuleName) > -1) {
                                    callback(null, `the ` + `${__1.REQUIRE_FUNC_NAME}("node", "${childModuleName}")`);
                                    return;
                                }
                                ...
                                callback(null, `the ` + `${__1.REQUIRE_FUNC_NAME}("node", "${child.name}", "${child.version}")`);
                                return;
                            }
                            if (childModuleName.startsWith(".") && childModuleName !== localPath) {
                                ...
                                callback(null, `the ` +
                                    `${__1.REQUIRE_FUNC_NAME}("local", "${depInfo.name}", "${depInfo.version}")`);
                                return;
                            }
                            callback();
                        })],
    ...
    addNodePackage(name, version) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existingModuleInfo = this.modules.find((m) => m.type === "node" && m.name === name && m.version === version);
            if (existingModuleInfo) {
                return existingModuleInfo;
            }
            if (yield util_1.promisify(fs_1.exists)(newebFile)) {
            ...
            const info = { name, version, modules: [], type: "node" };
            this.modules.push(info);
            return new Promise((resolve, reject) => {
                webpack({
                    entry: name,
